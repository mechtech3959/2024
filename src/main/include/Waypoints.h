...
constexpr units::degree_t AmpHeading =
    0_deg; // set to zero until heading is figured out

constexpr frc::Translation2d BlueTop{
    250.50_in,
    260.64_in}; // right of the field avoiding stage and goes to midfield
constexpr frc::Translation2d BlueBottom{
    250.50_in,
